...
<div class="container">
    ...
    <p>Hi, my name is Marialine. <br>
        This is a project that I've made. It has been build with Visual Studio Code. <br>
        I have made this site because I love poems and I wanted to share it with you. <br>
        On this page, I have posted every resources that I have used to build this website.<br>
    </p>

    <br><br>

    <h3>Acknolwledgments</h3>
